...
[SCENARIO: FOLDER-AUTH-001] TITLE: Unrestricted mode allows all paths TAGS: unit security
...
[SCENARIO: FOLDER-AUTH-002] TITLE: Whitelist mode blocks unauthorized paths TAGS: unit security
  GIVEN signal_bus_is_clean
  WHEN add_authorized_folder agent_id="agent_wl" folder="src"
...
[SCENARIO: FOLDER-AUTH-003] TITLE: Whitelist mode allows authorized paths TAGS: unit security
  GIVEN signal_bus_is_clean
  WHEN add_authorized_folder agent_id="agent_wl2" folder="src"
  WHEN check_folder_access agent_id="agent_wl2" path="src/app.ex" project_root="/tmp/test" mode="whitelist"
  THEN assert_folder_access result="ok"

[SCENARIO: FOLDER-AUTH-004] TITLE: Remove folder reverts to unrestricted when empty TAGS: unit security
  GIVEN signal_bus_is_clean
  WHEN add_authorized_folder agent_id="agent_rm" folder="src"
